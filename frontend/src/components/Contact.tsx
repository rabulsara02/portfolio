          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:rahulvbulsara@gmail.com"
                      className="text-gray-900 hover:text-blue-600"
                    >
                      rahulvbulsara@gmail.com
                    </a>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/rabulsara02"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-900 rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors"
                  aria-label="GitHub"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/rahulbulsara30/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-[#0A66C2] rounded-lg flex items-center justify-center hover:bg-[#004182] transition-colors"
                  aria-label="LinkedIn"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
